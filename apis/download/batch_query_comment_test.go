...
func TestBatchQueryComment(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc("/billcommentsp/batchquerycomment", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotResult, err := BatchQueryComment(test.MockWXPay, tt.args.params)
