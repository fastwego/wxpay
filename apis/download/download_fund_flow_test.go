...
func TestDownloadFundFlow(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc("/pay/downloadfundflow", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotResult, err := DownloadFundFlow(test.MockWXPay, tt.args.params)
